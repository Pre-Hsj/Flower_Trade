...
class OrderGoods(BaseModel):
    ...
    business = models.CharField(max_length=20, default='', verbose_name='商家ID')
...
class OrderSons(BaseModel):
    '''订单商品模型类'''
    order = models.ForeignKey('OrderInfo', verbose_name='订单', on_delete=models.CASCADE)
    bussiness = models.ForeignKey('bussiness.Bussiness', verbose_name='商家ID', on_delete=models.CASCADE)
